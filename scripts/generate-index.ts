...
async function generate() {
  ...
  const schema : CollectionCreateSchema = {
    ...
    fields: [
      ...
      { name: "language", type: "string", sort: true , facet: true},
      { name: "sub_genre", type: "string", sort: true, facet: true },
      { name: "main_genre", type: "string", sort: true, facet: true },
      { name: "place", type: "string", sort: true, facet: true },
      ...
      { name: "bibl_quotes", type: "string[]", facet: true, optional: true },
      { name: "parallels", type: "string[]", facet: true, optional: true },
  ...
  .map((value) => ({
   sort_id: value.id,
        ...
        sub_genre: value.work[0]?.genre[0]?.sub_genre || '',      
